     ...
     $.extend({
         config: {
             ...
             productFullName: "Mudbox Developer Help",
             defaultPage:  "./files/GUID-ADDDF686-12F9-4603-8E75-9612AC943AB3.htm",
             locale: "en_US",
 ...
 labels: {
     ...
     home: "Home: Mudbox Developer Help",
     print: "Print Frame",
...
contentFilters: [
{ id: 'prog', filter: 'files/.*htm', enabled: true, label: 'Programming Guide' },
{ id: 'cpp_ref', filter: 'cpp_ref/((?!8h_source).)*\.html', enabled: true, label: 'C++ API Reference and examples' },
{ id: 'headers', filter: 'cpp_ref/.*8h_source\.html', enabled: true, label: 'C++ header files' }
]
