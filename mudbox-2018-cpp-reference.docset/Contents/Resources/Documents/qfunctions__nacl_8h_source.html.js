...
<html>\n\
   <head><script src=\"../scripts/yepnope.1.5.4-min.js\" type=\"text/javascript\"></script><script src=\"../scripts/lib/jquery-1.11.1.min.js\" type=\"text/javascript\"></script><meta http-equiv=\"Content-Type\" content=\"text/html; charset=UTF-8\"><meta name=\"product\" content=\"MOBPRO\"><meta name=\"release\" content=\"2018\"><meta name=\"book\" content=\"GeneralUser\"><meta name=\"created\" content=\"2017-09-08\"><meta name=\"topicid\" content=\"GUID-02FA7DD3-6C7A-4C6A-B7BC-824765AE1CB2\"><meta name=\"topic-type\" content=\"concept\">\n\
      <title>QtCore/qfunctions_nacl.h Source File</title>\n\
   \n\
\n\
</head>\n\
...
function cpp_ref_initializeToc(forceTrigger) {\n\
    ...
    cpp_ref_adsk_ref_toc.initNavTree(\'qfunctions__nacl_8h_source.html\', tocPrefix);\n\
...
$(window).load( function() {\n\
 ...
 if (!tocSystemNeedsToBeLoaded) { cpp_ref_initializeToc(); }\n\
      ...
      <div>\n\
         <div class=\"head\">\n\
            <h1>QtCore/qfunctions_nacl.h Source File</h1>\n\
         </div>\n\
\n\
...
<div class=\"title\">qfunctions_nacl.h</div>  </div>\n\
</div><!--header-->\n\
<div class=\"contents\">\n\
<a href=\"#!/url=./cpp_ref/qfunctions__nacl_8h.html\">Go to the documentation of this file.</a><div class=\"fragment\"><div class=\"line\"><a name=\"l00001\"></a><span class=\"lineno\">    1</span>&#160;<span class=\"comment\">/****************************************************************************</span></div>\n\
...
<div class=\"line\"><a name=\"l00042\"></a><span class=\"lineno\">   42</span>&#160;<span class=\"preprocessor\">#ifndef QNACLUNIMPLEMENTED_H</span></div>\n\
<div class=\"line\"><a name=\"l00043\"></a><span class=\"lineno\">   43</span>&#160;<span class=\"preprocessor\">#define QNACLUNIMPLEMENTED_H</span></div>\n\
<div class=\"line\"><a name=\"l00044\"></a><span class=\"lineno\">   44</span>&#160;</div>\n\
<div class=\"line\"><a name=\"l00045\"></a><span class=\"lineno\">   45</span>&#160;<span class=\"preprocessor\">#ifdef Q_OS_NACL</span></div>\n\
<div class=\"line\"><a name=\"l00046\"></a><span class=\"lineno\">   46</span>&#160;</div>\n\
<div class=\"line\"><a name=\"l00047\"></a><span class=\"lineno\">   47</span>&#160;<span class=\"preprocessor\">#include &lt;sys/types.h&gt;</span></div>\n\
<div class=\"line\"><a name=\"l00048\"></a><span class=\"lineno\">   48</span>&#160;</div>\n\
<div class=\"line\"><a name=\"l00049\"></a><span class=\"lineno\">   49</span>&#160;<span class=\"comment\">// pthread</span></div>\n\
<div class=\"line\"><a name=\"l00050\"></a><span class=\"lineno\">   50</span>&#160;<span class=\"preprocessor\">#include &lt;pthread.h&gt;</span></div>\n\
<div class=\"line\"><a name=\"l00051\"></a><span class=\"lineno\">   51</span>&#160;<span class=\"preprocessor\">#define PTHREAD_CANCEL_DISABLE 1</span></div>\n\
<div class=\"line\"><a name=\"l00052\"></a><span class=\"lineno\">   52</span>&#160;<span class=\"preprocessor\">#define PTHREAD_CANCEL_ENABLE 2</span></div>\n\
<div class=\"line\"><a name=\"l00053\"></a><span class=\"lineno\">   53</span>&#160;<span class=\"preprocessor\">#define PTHREAD_INHERIT_SCHED 3</span></div>\n\
...
<div class=\"line\"><a name=\"l00059\"></a><span class=\"lineno\">   59</span>&#160;QT_MODULE(Core)</div>\n\
<div class=\"line\"><a name=\"l00060\"></a><span class=\"lineno\">   60</span>&#160;</div>\n\
<div class=\"line\"><a name=\"l00061\"></a><span class=\"lineno\">   61</span>&#160;extern &quot;C&quot; {</div>\n\
<div class=\"line\"><a name=\"l00062\"></a><span class=\"lineno\">   62</span>&#160;</div>\n\
<div class=\"line\"><a name=\"l00063\"></a><span class=\"lineno\">   63</span>&#160;<span class=\"keywordtype\">void</span> pthread_cleanup_push(<span class=\"keywordtype\">void</span> (*handler)(<span class=\"keywordtype\">void</span> *), <span class=\"keywordtype\">void</span> *arg);</div>\n\
<div class=\"line\"><a name=\"l00064\"></a><span class=\"lineno\">   64</span>&#160;<span class=\"keywordtype\">void</span> pthread_cleanup_pop(<span class=\"keywordtype\">int</span> execute);</div>\n\
<div class=\"line\"><a name=\"l00065\"></a><span class=\"lineno\">   65</span>&#160;</div>\n\
<div class=\"line\"><a name=\"l00066\"></a><span class=\"lineno\">   66</span>&#160;<span class=\"keywordtype\">int</span> pthread_setcancelstate(<span class=\"keywordtype\">int</span> state, <span class=\"keywordtype\">int</span> *oldstate);</div>\n\
<div class=\"line\"><a name=\"l00067\"></a><span class=\"lineno\">   67</span>&#160;<span class=\"keywordtype\">int</span> pthread_setcanceltype(<span class=\"keywordtype\">int</span> <a class=\"code\" href=\"#!/url=./cpp_ref/_g_lee_8h.html#a63267399cd2a2ee217572c11d2e54f07\">type</a>, <span class=\"keywordtype\">int</span> *oldtype);</div>\n\
<div class=\"line\"><a name=\"l00068\"></a><span class=\"lineno\">   68</span>&#160;<span class=\"keywordtype\">void</span> pthread_testcancel(<span class=\"keywordtype\">void</span>);</div>\n\
<div class=\"line\"><a name=\"l00069\"></a><span class=\"lineno\">   69</span>&#160;<span class=\"keywordtype\">int</span> pthread_cancel(pthread_t thread);</div>\n\
<div class=\"line\"><a name=\"l00070\"></a><span class=\"lineno\">   70</span>&#160;</div>\n\
<div class=\"line\"><a name=\"l00071\"></a><span class=\"lineno\">   71</span>&#160;<span class=\"keywordtype\">int</span> pthread_attr_setinheritsched(pthread_attr_t *attr,</div>\n\
<div class=\"line\"><a name=\"l00072\"></a><span class=\"lineno\">   72</span>&#160;    <span class=\"keywordtype\">int</span> inheritsched);</div>\n\
<div class=\"line\"><a name=\"l00073\"></a><span class=\"lineno\">   73</span>&#160;<span class=\"keywordtype\">int</span> pthread_attr_getinheritsched(<span class=\"keyword\">const</span> pthread_attr_t *attr, </div>\n\
<div class=\"line\"><a name=\"l00074\"></a><span class=\"lineno\">   74</span>&#160;    <span class=\"keywordtype\">int</span> *inheritsched);</div>\n\
<div class=\"line\"><a name=\"l00075\"></a><span class=\"lineno\">   75</span>&#160;</div>\n\
<div class=\"line\"><a name=\"l00076\"></a><span class=\"lineno\">   76</span>&#160;<span class=\"comment\">// event dispatcher, select</span></div>\n\
<div class=\"line\"><a name=\"l00077\"></a><span class=\"lineno\">   77</span>&#160;<span class=\"comment\">//struct fd_set;</span></div>\n\
<div class=\"line\"><a name=\"l00078\"></a><span class=\"lineno\">   78</span>&#160;<span class=\"comment\">//struct timeval;</span></div>\n\
<div class=\"line\"><a name=\"l00079\"></a><span class=\"lineno\">   79</span>&#160;<span class=\"keywordtype\">int</span> fcntl(<span class=\"keywordtype\">int</span> fildes, <span class=\"keywordtype\">int</span> cmd, ...);</div>\n\
<div class=\"line\"><a name=\"l00080\"></a><span class=\"lineno\">   80</span>&#160;<span class=\"keywordtype\">int</span> sigaction(<span class=\"keywordtype\">int</span> sig, <span class=\"keyword\">const</span> <span class=\"keyword\">struct</span> sigaction * act, <span class=\"keyword\">struct</span> sigaction * oact);</div>\n\
<div class=\"line\"><a name=\"l00081\"></a><span class=\"lineno\">   81</span>&#160;</div>\n\
<div class=\"line\"><a name=\"l00082\"></a><span class=\"lineno\">   82</span>&#160;<span class=\"keyword\">typedef</span> <span class=\"keywordtype\">long</span> off64_t;</div>\n\
<div class=\"line\"><a name=\"l00083\"></a><span class=\"lineno\">   83</span>&#160;off64_t ftello64(<span class=\"keywordtype\">void</span> *stream);</div>\n\
<div class=\"line\"><a name=\"l00084\"></a><span class=\"lineno\">   84</span>&#160;off64_t lseek64(<span class=\"keywordtype\">int</span> fildes, off_t <a class=\"code\" href=\"#!/url=./cpp_ref/_g_lee_8h.html#a6ed43c61a3fbf165f2eaf5f39282e908\">offset</a>, <span class=\"keywordtype\">int</span> whence);</div>\n\
<div class=\"line\"><a name=\"l00085\"></a><span class=\"lineno\">   85</span>&#160;<span class=\"keywordtype\">int</span> open64(<span class=\"keyword\">const</span> <span class=\"keywordtype\">char</span> *path, <span class=\"keywordtype\">int</span> oflag, ...);</div>\n\
<div class=\"line\"><a name=\"l00086\"></a><span class=\"lineno\">   86</span>&#160;</div>\n\
<div class=\"line\"><a name=\"l00087\"></a><span class=\"lineno\">   87</span>&#160;}</div>\n\
<div class=\"line\"><a name=\"l00088\"></a><span class=\"lineno\">   88</span>&#160;</div>\n\
<div class=\"line\"><a name=\"l00089\"></a><span class=\"lineno\">   89</span>&#160;<span class=\"keywordtype\">int</span> select(<span class=\"keywordtype\">int</span> nfds, fd_set * readfds, fd_set * writefds, fd_set * errorfds, <span class=\"keyword\">struct</span> timeval * timeout);</div>\n\
...
<div class=\"line\"><a name=\"l00095\"></a><span class=\"lineno\">   95</span>&#160;<span class=\"preprocessor\">#endif //Q_OS_NACL</span></div>\n\
<div class=\"line\"><a name=\"l00096\"></a><span class=\"lineno\">   96</span>&#160;</div>\n\
<div class=\"line\"><a name=\"l00097\"></a><span class=\"lineno\">   97</span>&#160;<span class=\"preprocessor\">#endif //QNACLUNIMPLEMENTED_H </span></div>\n\
