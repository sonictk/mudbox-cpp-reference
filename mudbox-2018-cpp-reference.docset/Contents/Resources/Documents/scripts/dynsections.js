...
$(window).load(function() {
  dQuery('.code,.codeRef').each(function() {
    dQuery(this).data('powertip',dQuery('#'+dQuery(this).attr('href').replace(/.*\//,'').replace(/[^a-z_A-Z0-9]/g,'_')).html());
    dQuery(this).powerTip({ placement: 's', smartPlacement: true, mouseOnToPopup: true });
  });
});
