...
<html>\n\
   <head><script src=\"../scripts/yepnope.1.5.4-min.js\" type=\"text/javascript\"></script><script src=\"../scripts/lib/jquery-1.11.1.min.js\" type=\"text/javascript\"></script><meta http-equiv=\"Content-Type\" content=\"text/html; charset=UTF-8\"><meta name=\"product\" content=\"MOBPRO\"><meta name=\"release\" content=\"2018\"><meta name=\"book\" content=\"GeneralUser\"><meta name=\"created\" content=\"2017-09-08\"><meta name=\"topicid\" content=\"GUID-02FA7DD3-6C7A-4C6A-B7BC-824765AE1CB2\"><meta name=\"topic-type\" content=\"concept\">\n\
      <title>PtexExtractor/ptex/PtexSeparableKernel.cpp</title>\n\
   \n\
\n\
</head>\n\
...
function cpp_ref_initializeToc(forceTrigger) {\n\
    ...
    cpp_ref_adsk_ref_toc.initNavTree(\'_ptex_extractor_2ptex_2_ptex_separable_kernel_8cpp-example.html\', tocPrefix);\n\
...
$(window).load( function() {\n\
 ...
 if (!tocSystemNeedsToBeLoaded) { cpp_ref_initializeToc(); }\n\
      ...
      <div>\n\
         <div class=\"head\">\n\
            <h1>PtexExtractor/ptex/PtexSeparableKernel.cpp</h1>\n\
         </div>\n\
\n\
...
<div class=\"title\">PtexExtractor/ptex/PtexSeparableKernel.cpp</div>  </div>\n\
</div><!--header-->\n\
<div class=\"contents\">\n\
...
<div class=\"line\">    <span class=\"keywordtype\">void</span> Apply(PtexSeparableKernel&amp; k, <span class=\"keywordtype\">double</span>* result, <span class=\"keywordtype\">void</span>* <a class=\"code\" href=\"#!/url=./cpp_ref/_g_lee_8h.html#a2cc7c8468af76cf855e1755c27945693\">data</a>, <span class=\"keywordtype\">int</span> <span class=\"comment\">/*nChan*/</span>, <span class=\"keywordtype\">int</span> <span class=\"comment\">/*nTxChan*/</span>)</div>\n\
<div class=\"line\">    {</div>\n\
<div class=\"line\">    <span class=\"keywordtype\">double</span>* rowResult = (<span class=\"keywordtype\">double</span>*) alloca(nChan*<span class=\"keyword\">sizeof</span>(<span class=\"keywordtype\">double</span>));</div>\n\
<div class=\"line\">    <span class=\"keywordtype\">int</span> rowlen = k.res.u() * nChan;</div>\n\
<div class=\"line\">    <span class=\"keywordtype\">int</span> datalen = k.uw * nChan;</div>\n\
<div class=\"line\">    <span class=\"keywordtype\">int</span> rowskip = rowlen - datalen;</div>\n\
<div class=\"line\">    <span class=\"keywordtype\">double</span>* kvp = k.kv;</div>\n\
<div class=\"line\">    T* <a class=\"code\" href=\"#!/url=./cpp_ref/_g_lee_8h.html#aa5367c14d90f462230c2611b81b41d23\">p</a> = (T*)data + (k.v * k.res.u() + k.u) * nChan;</div>\n\
<div class=\"line\">    T* pEnd = p + k.vw * rowlen;</div>\n\
<div class=\"line\">    <span class=\"keywordflow\">while</span> (p != pEnd)</div>\n\
<div class=\"line\">    {</div>\n\
<div class=\"line\">        <span class=\"keywordtype\">double</span>* kup = k.ku;</div>\n\
<div class=\"line\">        T* pRowEnd = p + datalen;</div>\n\
<div class=\"line\">        <span class=\"comment\">// just mult and copy first element</span></div>\n\
<div class=\"line\">        PtexUtils::VecMult&lt;T,nChan&gt;()(rowResult, p, *kup++);</div>\n\
<div class=\"line\">        p += nChan;</div>\n\
<div class=\"line\">        <span class=\"comment\">// accumulate remaining elements</span></div>\n\
<div class=\"line\">        <span class=\"keywordflow\">while</span> (p != pRowEnd) {</div>\n\
<div class=\"line\">        <span class=\"comment\">// rowResult[i] = p[i] * ku[u] for i in {0..n-1}</span></div>\n\
<div class=\"line\">        PtexUtils::VecAccum&lt;T,nChan&gt;()(rowResult, p, *kup++);</div>\n\
<div class=\"line\">        p += nChan;</div>\n\
<div class=\"line\">        }</div>\n\
<div class=\"line\">        <span class=\"comment\">// result[i] += rowResult[i] * kv[v] for i in {0..n-1}</span></div>\n\
<div class=\"line\">        PtexUtils::VecAccum&lt;double,nChan&gt;()(result, rowResult, *kvp++);</div>\n\
<div class=\"line\">        p += rowskip;</div>\n\
<div class=\"line\">    }</div>\n\
<div class=\"line\">    }</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">    <span class=\"comment\">// apply to 1..4 channels (unrolled channel loop) w/ pixel stride</span></div>\n\
<div class=\"line\">    <span class=\"keyword\">template</span>&lt;<span class=\"keyword\">class</span> T, <span class=\"keywordtype\">int</span> nChan&gt;</div>\n\
<div class=\"line\">    <span class=\"keywordtype\">void</span> ApplyS(PtexSeparableKernel&amp; k, <span class=\"keywordtype\">double</span>* result, <span class=\"keywordtype\">void</span>* data, <span class=\"keywordtype\">int</span> <span class=\"comment\">/*nChan*/</span>, <span class=\"keywordtype\">int</span> nTxChan)</div>\n\
<div class=\"line\">    {</div>\n\
<div class=\"line\">    <span class=\"keywordtype\">double</span>* rowResult = (<span class=\"keywordtype\">double</span>*) alloca(nChan*<span class=\"keyword\">sizeof</span>(<span class=\"keywordtype\">double</span>));</div>\n\
<div class=\"line\">    <span class=\"keywordtype\">int</span> rowlen = k.res.u() * nTxChan;</div>\n\
<div class=\"line\">    <span class=\"keywordtype\">int</span> datalen = k.uw * nTxChan;</div>\n\
<div class=\"line\">    <span class=\"keywordtype\">int</span> rowskip = rowlen - datalen;</div>\n\
<div class=\"line\">    <span class=\"keywordtype\">double</span>* kvp = k.kv;</div>\n\
<div class=\"line\">    T* <a class=\"code\" href=\"#!/url=./cpp_ref/_g_lee_8h.html#aa5367c14d90f462230c2611b81b41d23\">p</a> = (T*)data + (k.v * k.res.u() + k.u) * nTxChan;</div>\n\
<div class=\"line\">    T* pEnd = p + k.vw * rowlen;</div>\n\
<div class=\"line\">    <span class=\"keywordflow\">while</span> (p != pEnd)</div>\n\
<div class=\"line\">    {</div>\n\
<div class=\"line\">        <span class=\"keywordtype\">double</span>* kup = k.ku;</div>\n\
...
<div class=\"line\">    <span class=\"keywordtype\">void</span> ApplyN(PtexSeparableKernel&amp; k, <span class=\"keywordtype\">double</span>* result, <span class=\"keywordtype\">void</span>* data, <span class=\"keywordtype\">int</span> nChan, <span class=\"keywordtype\">int</span> nTxChan)</div>\n\
<div class=\"line\">    {</div>\n\
<div class=\"line\">    <span class=\"keywordtype\">double</span>* rowResult = (<span class=\"keywordtype\">double</span>*) alloca(nChan*<span class=\"keyword\">sizeof</span>(<span class=\"keywordtype\">double</span>));</div>\n\
<div class=\"line\">    <span class=\"keywordtype\">int</span> rowlen = k.res.u() * nTxChan;</div>\n\
<div class=\"line\">    <span class=\"keywordtype\">int</span> datalen = k.uw * nTxChan;</div>\n\
...
<div class=\"line\">        T* pRowEnd = p + datalen;</div>\n\
<div class=\"line\">        <span class=\"comment\">// just mult and copy first element</span></div>\n\
<div class=\"line\">        PtexUtils::VecMultN&lt;T&gt;()(rowResult, p, nChan, *kup++);</div>\n\
<div class=\"line\">        p += nTxChan;</div>\n\
<div class=\"line\">        <span class=\"comment\">// accumulate remaining elements</span></div>\n\
<div class=\"line\">        <span class=\"keywordflow\">while</span> (p != pRowEnd) {</div>\n\
<div class=\"line\">        <span class=\"comment\">// rowResult[i] = p[i] * ku[u] for i in {0..n-1}</span></div>\n\
<div class=\"line\">        PtexUtils::VecAccumN&lt;T&gt;()(rowResult, p, nChan, *kup++);</div>\n\
<div class=\"line\">        p += nTxChan;</div>\n\
<div class=\"line\">        }</div>\n\
<div class=\"line\">        <span class=\"comment\">// result[i] += rowResult[i] * kv[v] for i in {0..n-1}</span></div>\n\
<div class=\"line\">        PtexUtils::VecAccumN&lt;double&gt;()(result, rowResult, nChan, *kvp++);</div>\n\
<div class=\"line\">        p += rowskip;</div>\n\
<div class=\"line\">    }</div>\n\
<div class=\"line\">    }</div>\n\
<div class=\"line\">}</div>\n\
...
<div class=\"line\"></div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">PtexSeparableKernel::ApplyFn</div>\n\
<div class=\"line\">PtexSeparableKernel::applyFunctions[] = {</div>\n\
